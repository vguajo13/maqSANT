<?php
  session_start();
  $titulo = "<br>Registro de materiales";
...
<body>
    ...
    <h4>Registrar Nuevo material</h4>
        <form action="materialnuevoc.php" id="form2" method="POST" >
            <div >
                <div >
            <div>
                <label for="nombre">Nombre del material: </label>
                <textarea name="nombre" id="nombre" maxlength="50" cols="40" rows="5"></textarea>
            </div>

            <div>
                <label for="caracteristicas">Caracteristicas del material: </label>
