...
<body>
    ...
    <?php
        ...
        if($dbh != null){
            $stmt = $dbh -> prepare("SELECT idmaterial, nombre, caracteristicas
            FROM material ");
            ...
            if(!$datos){
                ...
                foreach($datos as $resultado){
                  $sku = $resultado['idmaterial'];
                  $nombre = $resultado['nombre'] ;
                  $caracteristicas = $resultado['caracteristicas'] ;

                  $datosget = "?id=$sku&nombre=$nombre&caracteristicas=$caracteristicas";


                    echo "<tr style='text-aling: center'>";
                    echo "<td>" . $resultado['idmaterial'] 
                    . "<br><br><a href='materialMod.php$datosget" 
                    ...
                    .'<br><br><a href="materialEliminar.php?id=' . $resultado['idmaterial'] 
